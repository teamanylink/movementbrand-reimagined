      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mt-6 max-w-xl ml-auto">
            <div className="absolute inset-0 bg-[#4169E1]/20 backdrop-blur-xl rounded-3xl" />
            <div className="relative p-8 rounded-3xl border border-white/20">
              <h3 className="text-sm font-semibold mb-2 text-white/80">THE BETTER WAY</h3>
              <h4 className="text-3xl font-bold mb-4 text-white">Superside</h4>
